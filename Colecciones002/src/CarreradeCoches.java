...
public class CarreradeCoches {
	...
	public static void main(String[] args) {
		...
		ArrayList<Coche> parrilla = new ArrayList<Coche>(); // Parrilla de salida con 5 coches , en este caso ponsdremos el arraylist
	
		
		parrilla.add(new Coche ("Ferrari",300)); //Agergamos los coches al arraylist, sin seleccionar la posición
		...
		Coche c1 = parrilla.get(0); //Apunta al que esta en la posición 1
		Coche c2 = parrilla.get(1); //Apunta al coche que esta en la posición 2
		c1.acelera(10);
		c2.frena(20);
		c1.parar();
		c2.recorre();
		...
		for(int i=0; i< parrilla.size(); i++){ //.size para saber el tamaño del arraylist
	...
	static void ordenarClasificacion (ArrayList <Coche> tcoches){
		tcoches.sort((c1, c2) -> c2.distanciaTotal - c1.distanciaTotal); // Compara la distancia
